...
final class GameController: NSObject, SCNSceneRendererDelegate {
    ...
    private func drown() {
        ...
        isHopping = false
        spawnBurst(at: SCNVector3(playerX, 0.2, Float(playerRow)), color: Palette.water, count: 16)
